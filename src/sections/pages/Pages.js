...
class Page2 extends Component {
  ...
  handleClick = (e) => {
    ...
    if (parseInt(e.currentTarget.id) === dataPage.multimedia.button.length - 1) {
      ...
      checkEndActivity(1, true); // FUNCION QUE RECIBE EL TRUE CUANDO FINALIZA LA ACTIVIDAD
    }
  }
  ...
  render() {
    ...
    return (
      <div className = 'pageContent animated fadeIn'>
        ...
        <InteractivePiramid dataPage = { dataPage } isEnded = { this.isEnded } />
...
class Page12 extends Component {
  ...
  handleClick = (e) => {
    ...
    if (parseInt(e.currentTarget.id) === dataPage.multimedia.button.length - 1) {
      // CUANDO NO SE ENVIA A COMPONENTES INTERNOS LA FUNCION SE PASA DE LA PROP
      checkEndActivity(11, true); // FUNCION QUE RECIBE EL TRUE CUANDO FINALIZA LA ACTIVIDAD
    }
  }
